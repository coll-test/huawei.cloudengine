...
from ansible_collections.huawei.cloudengine.plugins.modules import ce_lldp_interface
...
class TestCloudEngineLacpModule(TestCloudEngineModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.huawei.cloudengine.plugins.modules.ce_lldp_interface.get_nc_config')
        self.get_nc_config = self.mock_get_config.start()

        self.mock_set_nc_config = patch('ansible_collections.huawei.cloudengine.plugins.modules.ce_lldp_interface.set_nc_config')
