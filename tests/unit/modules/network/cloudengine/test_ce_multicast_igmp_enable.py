...
from ansible_collections.huawei.cloudengine.tests.unit.compat.mock import patch
from ansible_collections.huawei.cloudengine.plugins.modules import ce_multicast_igmp_enable
from ansible_collections.huawei.cloudengine.tests.unit.modules.network.cloudengine.ce_module import TestCloudEngineModule, load_fixture
from ansible_collections.huawei.cloudengine.tests.unit.modules.utils import set_module_args
...
class TestCloudEngineLacpModule(TestCloudEngineModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.huawei.cloudengine.plugins.modules.ce_multicast_igmp_enable.get_nc_config')
        self.get_nc_config = self.mock_get_config.start()

        self.mock_set_config = patch('ansible_collections.huawei.cloudengine.plugins.modules.ce_multicast_igmp_enable.set_nc_config')
