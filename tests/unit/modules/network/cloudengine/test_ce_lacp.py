...
from ansible_collections.huawei.cloudengine.plugins.modules import ce_lacp
...
class TestCloudEngineLacpModule(TestCloudEngineModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.huawei.cloudengine.plugins.modules.ce_lacp.get_nc_config')
        self.get_nc_config = self.mock_get_config.start()

        self.mock_set_config = patch('ansible_collections.huawei.cloudengine.plugins.modules.ce_lacp.set_nc_config')
